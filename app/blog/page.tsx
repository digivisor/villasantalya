...
// Recent posts için son 3 aktif blog yazısını al
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative h-96 overflow-hidden">
        <Image src="/blog-hero-bg.jpg" alt="Blog Hero" fill className="object-cover" />
        <div className="absolute inset-0 bg-black/50"></div>
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-4 w-full">
            <div className="text-white">
              <h1 className="text-5xl md:text-6xl font-bold mb-4">Emlak Blogumuz</h1>
              <p className="text-xl max-w-2xl mb-6">Gayrimenkul dünyasındaki son gelişmeler, yatırım tavsiyeleri, tasarım fikirleri ve daha fazlası</p>
                ...
                {filteredPosts.length > 0 ? filteredPosts.map((post, index) => (
                  ...
                  >
                    ...
                    <div className="p-8">
                      ...
                      {/* Title */}
                      <h2 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-4 hover:text-orange-500 transition-colors duration-300 cursor-pointer">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <Link href={`/blog/${post.slug}`}>
                          <Button
                            variant="ghost"
                            className="text-orange-500 hover:text-orange-600 hover:bg-orange-50 p-0 h-auto font-semibold"
                          >
                            Devamını Oku
                      ...
                      <div className="flex flex-wrap gap-2 mt-6 pt-6 border-t border-gray-100">
                        {post.tags.map((tag, tagIndex) => (
                          <span
                            ...
                            className="bg-gray-100 text-gray-600 px-3 py-1 rounded-full text-sm hover:bg-orange-100 hover:text-orange-600 transition-colors duration-300 cursor-pointer"
                          >
                            #{tag}
                          </span>
                        ))}
                  ...
                  <div className="bg-white p-8 rounded-3xl text-center">
                    <h3 className="text-2xl font-semibold text-gray-800 mb-2">Aradığınız kriterlere uygun yazı bulunamadı</h3>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-white rounded-3xl p-6 shadow-lg">
                <div className="relative">
                  ...
                  <Button
                    size="sm"
                    className="absolute right-2 top-2 h-8 w-8 p-0 bg-orange-500 hover:bg-orange-600 rounded-lg"
                  >
                ...
                <div className="space-y-3">
                  {categories.map((category, idx) => {
                    ...
                    return (
                      ...
                      >
                        <span className="font-medium text-gray-700 group-hover:text-orange-500">{category}</span>
                        <span className="bg-gray-100 text-gray-600 group-hover:bg-orange-100 group-hover:text-orange-600 px-2 py-1 rounded-full text-xs">
                          {count}
                        </span>
                      </div>
                    )
              ...
              {/* Instagram */}
              <div className="bg-white rounded-3xl p-6 shadow-lg">
                <h3 className="text-xl font-bold text-gray-900 mb-6">Instagram</h3>
                <div className="grid grid-cols-3 gap-2">
                  {blogPosts.slice(0, 6).map((post, idx) => (
                    <div
                      key={idx}
                      className="aspect-square rounded-xl overflow-hidden hover:scale-105 transition-transform duration-300 cursor-pointer relative"
                    >
                      <Image
                        src={post.image || "/placeholder.svg"}
                        alt={`Instagram ${idx + 1}`}
