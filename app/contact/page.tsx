      ...
      <header className="bg-gray-900/95 backdrop-blur-sm text-white py-4 px-4 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link href="/contact" className="text-orange-500 hover:text-orange-400 font-medium">
              İletişim
            </Link>
          </nav>
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden bg-gray-800 py-4 px-4 mt-2 rounded-lg">
            <div className="flex flex-col space-y-3">
              ...
              <Link href="/contact" className="text-orange-500 hover:text-orange-400 font-medium py-2">
                İletişim
              </Link>
            </div>
          </nav>
